function createSlide(pres, theme) {
  ...
  slide.addText("6 tools with real backends  |  Native Ollama tool calling  |  No LangChain", {
    x: 0.5, y: 3.7, w: 9, h: 0.4,
    fontSize: 14, color: theme.secondary, fontFace: "Segoe UI"
  });
  slide.addText("09", { x: 9.3, y: 5.1, w: 0.5, h: 0.35, fontSize: 10, color: theme.secondary, fontFace: "Segoe UI" });
}
