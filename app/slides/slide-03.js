function createSlide(pres, theme) {
  ...
  slide.addText("Full local stack - no cloud APIs", {
    ...
    fontSize: 13, color: theme.accent, fontFace: "Segoe UI", italic: true
  });
  slide.addText("03", { x: 9.3, y: 5.1, w: 0.5, h: 0.35, fontSize: 10, color: theme.secondary, fontFace: "Segoe UI" });
}
